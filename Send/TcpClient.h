...
typedef void (*ReCallFunForTcpClient)();
// 缺省值定义
...
#define WM_SENDFILERATE						(WM_TCPCLIENTBASE + 43) // 发送文件速率
// 前置声明
...
typedef void (*SendFileRateFun)(void *pNotifyObj, int nSendRate);
// Tcp客户端
class CTcpClient
{
private:
	...
	SendFileRateFun							m_OnSendFileRate;
	...
	void HandleSendFileRateMsg(void);
public:
	...
	void SetOnSendFileRate(SendFileRateFun OnSendFileRateFun);
